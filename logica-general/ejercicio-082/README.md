# Logica general 082 - validacion de datos
...
En este ejercicio debes resolver un caso de validacion de datos. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
