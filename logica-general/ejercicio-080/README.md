# Logica general 080 - estrategias de seleccion
...
En este ejercicio debes resolver un caso de estrategias de seleccion. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
