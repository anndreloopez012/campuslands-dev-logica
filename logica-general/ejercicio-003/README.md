...
En este ejercicio debes resolver un caso de toma de decisiones. La dificultad sube de forma gradual: aqui se espera trabajar con pocos datos y reglas directas.
