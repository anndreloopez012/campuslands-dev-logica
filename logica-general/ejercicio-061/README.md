# Logica general 061 - clasificacion por reglas
...
En este ejercicio debes resolver un caso de clasificacion por reglas. La dificultad sube de forma gradual: aqui se espera organizar datos antes de calcular o decidir.
