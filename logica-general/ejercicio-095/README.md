# Logica general 095 - reglas de negocio
...
En este ejercicio debes resolver un caso de reglas de negocio. La dificultad sube de forma gradual: aqui se espera integrar varias reglas sin perder claridad.
