# Logica general 081 - clasificacion por reglas
...
En este ejercicio debes resolver un caso de clasificacion por reglas. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
