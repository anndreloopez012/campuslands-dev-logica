# Logica general 062 - validacion de datos
...
En este ejercicio debes resolver un caso de validacion de datos. La dificultad sube de forma gradual: aqui se espera organizar datos antes de calcular o decidir.
