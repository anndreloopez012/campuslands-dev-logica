# Logica general 086 - busqueda de elementos
...
En este ejercicio debes resolver un caso de busqueda de elementos. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
