# Logica general 079 - inventarios logicos
...
En este ejercicio debes resolver un caso de inventarios logicos. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
