# Logica general 041 - clasificacion por reglas
...
En este ejercicio debes resolver un caso de clasificacion por reglas. La dificultad sube de forma gradual: aqui se espera combinar varias condiciones y revisar casos especiales.
