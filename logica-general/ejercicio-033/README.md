...
En este ejercicio debes resolver un caso de resolucion de casos. La dificultad sube de forma gradual: aqui se espera combinar varias condiciones y revisar casos especiales.
