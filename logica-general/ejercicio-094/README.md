# Logica general 094 - diagnostico de errores
...
Estas trabajando como estudiante de Campuslands en un reto de tatuajes. El objetivo no es memorizar codigo, sino analizar una situacion, convertirla en reglas claras y construir una solucion ordenada.

En este ejercicio debes resolver un caso de diagnostico de errores. La dificultad sube de forma gradual: aqui se espera integrar varias reglas sin perder claridad.
