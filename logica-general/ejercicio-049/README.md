# Logica general 049 - simulacion de estados
...
En este ejercicio debes resolver un caso de simulacion de estados. La dificultad sube de forma gradual: aqui se espera organizar datos antes de calcular o decidir.
