# Logica general 065 - ordenamiento de prioridades
...
En este ejercicio debes resolver un caso de ordenamiento de prioridades. La dificultad sube de forma gradual: aqui se espera organizar datos antes de calcular o decidir.
