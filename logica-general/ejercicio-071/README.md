# Logica general 071 - organizacion de listas
...
En este ejercicio debes resolver un caso de organizacion de listas. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
