# Logica general 072 - comparacion de opciones
...
En este ejercicio debes resolver un caso de comparacion de opciones. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
