# Logica general 085 - ordenamiento de prioridades
...
En este ejercicio debes resolver un caso de ordenamiento de prioridades. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
