# Logica general 088 - flujos paso a paso
...
En este ejercicio debes resolver un caso de flujos paso a paso. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
