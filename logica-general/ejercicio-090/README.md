# Logica general 090 - lectura de instrucciones
...
En este ejercicio debes resolver un caso de lectura de instrucciones. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
