# Logica general 075 - reglas de negocio
...
En este ejercicio debes resolver un caso de reglas de negocio. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
