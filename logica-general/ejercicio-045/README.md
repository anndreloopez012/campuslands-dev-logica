# Logica general 045 - ordenamiento de prioridades
...
Estas trabajando como estudiante de Campuslands en un reto de taller mecanico. El objetivo no es memorizar codigo, sino analizar una situacion, convertirla en reglas claras y construir una solucion ordenada.

En este ejercicio debes resolver un caso de ordenamiento de prioridades. La dificultad sube de forma gradual: aqui se espera combinar varias condiciones y revisar casos especiales.
