...
En este ejercicio debes resolver un caso de simulacion de estados. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
