...
En este ejercicio debes resolver un caso de ordenamiento de prioridades. La dificultad sube de forma gradual: aqui se espera trabajar con pocos datos y reglas directas.
