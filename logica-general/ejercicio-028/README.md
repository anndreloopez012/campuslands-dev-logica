# Logica general 028 - flujos paso a paso
...
Estas trabajando como estudiante de Campuslands en un reto de peliculas de ciencia ficcion. El objetivo no es memorizar codigo, sino analizar una situacion, convertirla en reglas claras y construir una solucion ordenada.

En este ejercicio debes resolver un caso de flujos paso a paso. La dificultad sube de forma gradual: aqui se espera combinar varias condiciones y revisar casos especiales.
