...
En este ejercicio debes resolver un caso de organizacion de listas. La dificultad sube de forma gradual: aqui se espera trabajar con pocos datos y reglas directas.
