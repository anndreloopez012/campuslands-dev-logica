...
En este ejercicio debes resolver un caso de estrategias de seleccion. La dificultad sube de forma gradual: aqui se espera trabajar con pocos datos y reglas directas.
