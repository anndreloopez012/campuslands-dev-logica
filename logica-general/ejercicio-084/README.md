# Logica general 084 - filtros por condiciones
...
En este ejercicio debes resolver un caso de filtros por condiciones. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
