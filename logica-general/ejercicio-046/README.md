# Logica general 046 - busqueda de elementos
...
En este ejercicio debes resolver un caso de busqueda de elementos. La dificultad sube de forma gradual: aqui se espera organizar datos antes de calcular o decidir.
