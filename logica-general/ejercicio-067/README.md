# Logica general 067 - deteccion de inconsistencias
...
Estas trabajando como estudiante de Campuslands en un reto de playlist musical. El objetivo no es memorizar codigo, sino analizar una situacion, convertirla en reglas claras y construir una solucion ordenada.

En este ejercicio debes resolver un caso de deteccion de inconsistencias. La dificultad sube de forma gradual: aqui se espera organizar datos antes de calcular o decidir.
