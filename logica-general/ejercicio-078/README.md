# Logica general 078 - sistemas de turnos
...
En este ejercicio debes resolver un caso de sistemas de turnos. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
