# Logica general 073 - resolucion de casos
...
En este ejercicio debes resolver un caso de resolucion de casos. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
