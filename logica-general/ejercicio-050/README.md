# Logica general 050 - lectura de instrucciones
...
En este ejercicio debes resolver un caso de lectura de instrucciones. La dificultad sube de forma gradual: aqui se espera organizar datos antes de calcular o decidir.
