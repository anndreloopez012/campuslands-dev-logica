# Logica general 042 - validacion de datos
...
En este ejercicio debes resolver un caso de validacion de datos. La dificultad sube de forma gradual: aqui se espera combinar varias condiciones y revisar casos especiales.
