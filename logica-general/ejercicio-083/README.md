# Logica general 083 - toma de decisiones
...
En este ejercicio debes resolver un caso de toma de decisiones. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
