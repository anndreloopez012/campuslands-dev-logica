# Logica general 064 - filtros por condiciones
...
Estas trabajando como estudiante de Campuslands en un reto de inventario de motos. El objetivo no es memorizar codigo, sino analizar una situacion, convertirla en reglas claras y construir una solucion ordenada.

En este ejercicio debes resolver un caso de filtros por condiciones. La dificultad sube de forma gradual: aqui se espera organizar datos antes de calcular o decidir.
