# Logica general 068 - flujos paso a paso
...
En este ejercicio debes resolver un caso de flujos paso a paso. La dificultad sube de forma gradual: aqui se espera organizar datos antes de calcular o decidir.
