...
En este ejercicio debes resolver un caso de comparacion de opciones. La dificultad sube de forma gradual: aqui se espera integrar varias reglas sin perder claridad.
