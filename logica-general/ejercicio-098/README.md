# Logica general 098 - sistemas de turnos
...
En este ejercicio debes resolver un caso de sistemas de turnos. La dificultad sube de forma gradual: aqui se espera integrar varias reglas sin perder claridad.
