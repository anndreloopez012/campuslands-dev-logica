# Logica general 100 - estrategias de seleccion
...
En este ejercicio debes resolver un caso de estrategias de seleccion. La dificultad sube de forma gradual: aqui se espera integrar varias reglas sin perder claridad.
