# Logica general 093 - resolucion de casos
...
En este ejercicio debes resolver un caso de resolucion de casos. La dificultad sube de forma gradual: aqui se espera integrar varias reglas sin perder claridad.
