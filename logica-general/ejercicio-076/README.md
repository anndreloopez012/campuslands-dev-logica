# Logica general 076 - matrices simples
...
En este ejercicio debes resolver un caso de matrices simples. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
