# Logica general 077 - tablas de decision
...
En este ejercicio debes resolver un caso de tablas de decision. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
