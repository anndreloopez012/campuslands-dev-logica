# Logica matematica 062 - porcentajes y proporciones
...
Estas trabajando como estudiante de Campuslands en un reto de ranking de futbol sala. El objetivo no es memorizar codigo, sino analizar una situacion, convertirla en reglas claras y construir una solucion ordenada.

En este ejercicio debes resolver un caso de porcentajes y proporciones. La dificultad sube de forma gradual: aqui se espera organizar datos antes de calcular o decidir.
