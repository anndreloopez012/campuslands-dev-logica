...
En este ejercicio debes resolver un caso de estadisticas de ranking. La dificultad sube de forma gradual: aqui se espera organizar datos antes de calcular o decidir.
