...
En este ejercicio debes resolver un caso de secuencias numericas. La dificultad sube de forma gradual: aqui se espera trabajar con pocos datos y reglas directas.
