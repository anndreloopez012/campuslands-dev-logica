...
En este ejercicio debes resolver un caso de presupuestos y descuentos. La dificultad sube de forma gradual: aqui se espera combinar varias condiciones y revisar casos especiales.
