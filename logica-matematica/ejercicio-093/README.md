# Logica matematica 093 - coordenadas y distancia
...
Estas trabajando como estudiante de Campuslands en un reto de paracaidismo. El objetivo no es memorizar codigo, sino analizar una situacion, convertirla en reglas claras y construir una solucion ordenada.

En este ejercicio debes resolver un caso de coordenadas y distancia. La dificultad sube de forma gradual: aqui se espera integrar varias reglas sin perder claridad.
