...
En este ejercicio debes resolver un caso de operaciones aritmeticas controladas. La dificultad sube de forma gradual: aqui se espera organizar datos antes de calcular o decidir.
