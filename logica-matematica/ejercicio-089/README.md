# Logica matematica 089 - modulos y divisibilidad
...
En este ejercicio debes resolver un caso de modulos y divisibilidad. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
