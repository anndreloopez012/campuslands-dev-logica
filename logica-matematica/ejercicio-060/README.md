...
En este ejercicio debes resolver un caso de simulaciones con formulas. La dificultad sube de forma gradual: aqui se espera organizar datos antes de calcular o decidir.
