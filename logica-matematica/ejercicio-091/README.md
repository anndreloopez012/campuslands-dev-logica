# Logica matematica 091 - conteo combinatorio simple
...
Estas trabajando como estudiante de Campuslands en un reto de kickboxing. El objetivo no es memorizar codigo, sino analizar una situacion, convertirla en reglas claras y construir una solucion ordenada.

En este ejercicio debes resolver un caso de conteo combinatorio simple. La dificultad sube de forma gradual: aqui se espera integrar varias reglas sin perder claridad.
