# Logica matematica 096 - presupuestos y descuentos
...
Estas trabajando como estudiante de Campuslands en un reto de animacion 3D. El objetivo no es memorizar codigo, sino analizar una situacion, convertirla en reglas claras y construir una solucion ordenada.

En este ejercicio debes resolver un caso de presupuestos y descuentos. La dificultad sube de forma gradual: aqui se espera integrar varias reglas sin perder claridad.
