...
En este ejercicio debes resolver un caso de promedios y medianas. La dificultad sube de forma gradual: aqui se espera trabajar con pocos datos y reglas directas.
