# Logica matematica 098 - normalizacion de puntajes
...
Estas trabajando como estudiante de Campuslands en un reto de soldadura. El objetivo no es memorizar codigo, sino analizar una situacion, convertirla en reglas claras y construir una solucion ordenada.

En este ejercicio debes resolver un caso de normalizacion de puntajes. La dificultad sube de forma gradual: aqui se espera integrar varias reglas sin perder claridad.
