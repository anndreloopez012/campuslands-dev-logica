# Logica matematica 095 - velocidad tiempo distancia

## Dificultad

Reto integrador controlado
...
Estas trabajando como estudiante de Campuslands en un reto de dibujo digital. El objetivo no es memorizar codigo, sino analizar una situacion, convertirla en reglas claras y construir una solucion ordenada.

En este ejercicio debes resolver un caso de velocidad tiempo distancia. La dificultad sube de forma gradual: aqui se espera integrar varias reglas sin perder claridad.
