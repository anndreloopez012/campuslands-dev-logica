# Logica matematica 088 - patrones de puntuacion
...
En este ejercicio debes resolver un caso de patrones de puntuacion. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
