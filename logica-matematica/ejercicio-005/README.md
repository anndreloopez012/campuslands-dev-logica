...
En este ejercicio debes resolver un caso de minimos y limites. La dificultad sube de forma gradual: aqui se espera trabajar con pocos datos y reglas directas.
