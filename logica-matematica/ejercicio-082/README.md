# Logica matematica 082 - porcentajes y proporciones
...
En este ejercicio debes resolver un caso de porcentajes y proporciones. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
