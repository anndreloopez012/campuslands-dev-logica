# Logica matematica 052 - probabilidad basica
...
En este ejercicio debes resolver un caso de probabilidad basica. La dificultad sube de forma gradual: aqui se espera organizar datos antes de calcular o decidir.
