# Logica matematica 030 - redondeo y precision
...
Estas trabajando como estudiante de Campuslands en un reto de viajes y turismo. El objetivo no es memorizar codigo, sino analizar una situacion, convertirla en reglas claras y construir una solucion ordenada.

En este ejercicio debes resolver un caso de redondeo y precision. La dificultad sube de forma gradual: aqui se espera combinar varias condiciones y revisar casos especiales.
