# Logica matematica 092 - probabilidad basica
...
En este ejercicio debes resolver un caso de probabilidad basica. La dificultad sube de forma gradual: aqui se espera integrar varias reglas sin perder claridad.
