...
En este ejercicio debes resolver un caso de secuencias numericas. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
