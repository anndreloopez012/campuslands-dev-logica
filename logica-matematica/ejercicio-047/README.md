# Logica matematica 047 - secuencias numericas
...
En este ejercicio debes resolver un caso de secuencias numericas. La dificultad sube de forma gradual: aqui se espera organizar datos antes de calcular o decidir.
