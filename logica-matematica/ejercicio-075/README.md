# Logica matematica 075 - velocidad tiempo distancia
...
En este ejercicio debes resolver un caso de velocidad tiempo distancia. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
