...
En este ejercicio debes resolver un caso de conversion de unidades. La dificultad sube de forma gradual: aqui se espera organizar datos antes de calcular o decidir.
