# Logica matematica 100 - simulaciones con formulas
...
En este ejercicio debes resolver un caso de simulaciones con formulas. La dificultad sube de forma gradual: aqui se espera integrar varias reglas sin perder claridad.
