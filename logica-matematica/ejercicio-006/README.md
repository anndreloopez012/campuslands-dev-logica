...
En este ejercicio debes resolver un caso de conversion de unidades. La dificultad sube de forma gradual: aqui se espera trabajar con pocos datos y reglas directas.
