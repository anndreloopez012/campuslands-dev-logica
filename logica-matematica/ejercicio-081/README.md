# Logica matematica 081 - operaciones aritmeticas controladas
...
En este ejercicio debes resolver un caso de operaciones aritmeticas controladas. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
