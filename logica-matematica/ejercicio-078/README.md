# Logica matematica 078 - normalizacion de puntajes
...
En este ejercicio debes resolver un caso de normalizacion de puntajes. La dificultad sube de forma gradual: aqui se espera separar el problema en funciones pequenas.
