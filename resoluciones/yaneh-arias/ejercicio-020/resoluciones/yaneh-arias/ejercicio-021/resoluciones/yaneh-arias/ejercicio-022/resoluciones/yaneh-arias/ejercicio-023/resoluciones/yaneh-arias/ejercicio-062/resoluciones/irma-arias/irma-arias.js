...
function calcularTorneoEsports(puntajes, bono, penalizacion) {
    ...
    // Ordenar puntajes para obtener la mediana
...
// Pruebas
console.log("Prueba Normal:", calcularTorneoEsports([12, 18, 25, 30], 8, 3));
console.log("Prueba Borde:", calcularTorneoEsports([20], 5, 2));